                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="mb-10 text-center">
                        <h1 className="text-3xl md:text-4xl font-bold text-[#003399] mb-2">
                            Epson Solutions Center
                        </h1>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Explore our suite of tools designed to enhance your Epson experience
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                            <div className="p-6">
                                ...
                                <p className="text-gray-600 mb-6">Verify your Epson limited warranty and Service Plans quickly and easily.</p>
                ...
                <div className="max-w-6xl mx-auto px-6 md:px-10">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="mb-4 md:mb-0">
                            <h3 className="text-xl font-bold">Epson</h3>
                    ...
                    {/* <div className="mt-4 text-center md:text-left text-blue-100 text-sm">
                        <p>&copy; {new Date().getFullYear()} Epson Corporation. All rights reserved.</p>
                    </div> */}
                </div>
            </footer>
        </div>
