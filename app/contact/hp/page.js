...
//       router.push(`./hp/install?model=${encodeURIComponent(searchPath)}`); // Navigate to the install page
//     } else {
...
//             <h1 className="text-4xl font-hp-simplified text-[44px] 2xl:ml-[-28px] xl:ml-[-64px]">Get started with your HP printer</h1>
//             <p className="mt-[35px] text-[24px] xl:ml-[209px] 2xl:ml-[251px]">Enter your printer name and model number to get the right HP software and drivers.</p>
...
//               <ul className="absolute left-0 mt-1 w-full max-w-lg bg-white border border-gray-300 rounded-lg shadow-lg z-10 2xl:ml-[255px] xl:ml-[210px] text-black">
  ...
  <div className="relative z-10">
    {/* <h1 className="text-white">Your Content Here</h1> */}
          ...
          <div className="relative z-10 text-white 2xl:mt-[117px] xl:mt-[165px] 2xl:ml-[-825px] xl:ml-[-327px]  ">
            ...
            {/* Dropdown for filtered models */}
            {filteredModels.length > 0 && (
              <ul className="absolute left-0 mt-1 w-full max-w-lg bg-white border border-gray-300 rounded-lg shadow-lg z-10 2xl:ml-[138px] xl:ml-[92px] text-black">
                {filteredModels.map((model) => (
                  <li
                    key={model}
                    onClick={() => handleModelClick(model)} // Set model on click
        ...
        <div className='2xl:ml-[189px] xl:ml-[130px]' style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <h1 className='text-[#737373] ml-[10px]'>
            Need additional help with setup? Visit <span className='underline' style={{ color: '#007DBA' }}> Support</span>
          </h1>
        </div>
        <div className="flex items-center 2xl:ml-[193px] 2xl:mt-[59px] xl:ml-[130px] xl:mt-[63px]">
          <Image src="/unitedlogo.png" alt="United States"
