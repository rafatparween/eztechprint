    ...
    return (
        <footer className="text-white py-20 bg-black h-[400px] pt-[14px]">
            <div className="container mx-auto px-20 lg:px-20 py-20 flex flex-col gap-10 md:flex-row justify-between border-t border-slate-800">
                <div className="flex">
                    <div className="font-bold text-center">
                        <h1 className="text-[32px] mt-[89px]">  Ij Printer Live Solution</h1>
                    </div>
                </div>
            ...
            <div className="flex items-center justify-center py-10 mt-[-103px]">
                <span className="text-gray-400 leading-10">© Copyright, All Rights Reserved by ijprinterlivesolution </span>
            </div>
        </footer>
    );
};
