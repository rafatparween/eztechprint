...
const PrivacyPolicy = () => {
  return (
    <>
      <Head>
        <title>Privacy Policy | Micro Hub Care</title>
        <meta name="description" content="Privacy policy page for Micro Hub Care" />
      </Head>
      ...
      <div className="bg-gradient-to-r from-blue-500 via-teal-600 to-indigo-700 min-h-screen py-12 px-6 md:px-12 pt-16">
        <div className="max-w-7xl mx-auto bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="space-y-8 text-gray-700">
            <p>
              At Micro Hub Care, your privacy is a top priority for us. This Privacy Policy outlines how we collect, use, and protect your personal information when you visit our website and use our services. By accessing or using our website, you agree to the terms outlined in this policy.
            </p>
